...
},{"./vnode":"node_modules/snabbdom/src/package/vnode.ts","./is":"node_modules/snabbdom/src/package/is.ts"}],"src/01-basicusage.js":[function(require,module,exports) {
"use strict";
...
var app = document.querySelector('#app'); // 第一个参数：可以是DOM元素，内部会把DOM元素转换成Vnode
// 第二个参数：Vnode
// 返回值：Vnode

var oldVal = patch(app, vnode); // 假设的数据更新时刻

vnode = (0, _h.h)('div', 'hello snabbdom');
patch(oldVal, vnode);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "4160" + '/');
